...
class Application {
  ...
  _makeUsers(data) {
    let index = 0;
      ...
      for (let userData of data) {
        this.users.set(++index, new _user__WEBPACK_IMPORTED_MODULE_0__["default"](userData));
      }
      console.log(this.users);
  }
  _renderUserList() {
    this._userList = new _userList__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  onClick() {
    if (event.target.hasAttribute('data-user-index')) {
      ...
      this.form = new _userForm__WEBPACK_IMPORTED_MODULE_2__["default"](user);
...
function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;pug_html = pug_html + "\u003Cdiv class=\"user-list\"\u003EEmpty user list\u003C\u002Fdiv\u003E";;return pug_html;};
...
/*!********************!*\
  !*** ./src/lib.js ***!
  \********************/
/*! exports provided: createElementFromHtml */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class UserForm {
  ...
  render() {
    ...
    this.elem = _lib__WEBPACK_IMPORTED_MODULE_0__["createElementFromHtml"](_.template(template)({ user: this.user }));
  }
  process() {
    const data = {};
...
/* harmony import */ var _emptyUserList_pug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./emptyUserList.pug */ "./src/emptyUserList.pug");
/* harmony import */ var _emptyUserList_pug__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_emptyUserList_pug__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _lib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib */ "./src/lib.js");
...
class UserList {
  ...
  _render() {
    this.elem = _lib__WEBPACK_IMPORTED_MODULE_1__["createElementFromHtml"](_emptyUserList_pug__WEBPACK_IMPORTED_MODULE_0___default()());
  }
  showUsers(users) {
    const template = `
      <ul>
